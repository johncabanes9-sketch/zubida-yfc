...
type Tab = "registrations" | "events" | "chapters" | "leaders" | "pages" | "users" | "logs" | "settings";
...
const baseTabs: { key: Tab; href: string; label: string; pyhOnly?: boolean }[] = [
  ...
  { key: "chapters", href: "/admin/chapters", label: "Chapters" },
  { key: "leaders", href: "/admin/leaders", label: "Leaders" },
